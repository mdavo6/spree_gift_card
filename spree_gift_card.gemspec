Gem::Specification.new do |s|
  ...
  s.add_dependency 'spree_api',         '>= 3.2.0' , '< 5.0'
  s.add_dependency 'spree_backend',     '>= 3.2.0' , '< 5.0'
  s.add_dependency 'spree_core',        '>= 3.2.0' , '< 5.0'
  s.add_dependency 'spree_frontend',    '>= 3.2.0' , '< 5.0'
